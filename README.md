...
- [DocumentCloud_updater/list_comparison.py](https://github.com/Howard-Center-Investigations/FARA_Archive/blob/main/DocumentCloud_updater/list_comparison.py) compares the most recent copy of [FARA_All_RegistrantDocs.csv](https://github.com/Howard-Center-Investigations/FARA_Archive/raw/refs/heads/main/bulk_data_files/FARA_All_RegistrantDocs.csv) from [FARA.gov](https://FARA.gov) to the prior day's copy. Any new documents that have been made available on FARA.gov are then uploaded to DocumentCloud via [DocumentCloud_updater/upload_to_documentcloud.py](https://github.com/Howard-Center-Investigations/FARA_Archive/blob/main/DocumentCloud_updater/upload_to_documentcloud.py).
- [datasets/browse_filings_scraper.py](https://github.com/Howard-Center-Investigations/FARA_Archive/blob/main/datasets/browse_filings_scraper.py) uses Playwright to scrape datasets from the [Browse Filings](https://efile.fara.gov/ords/fara/f?p=1381:1:1551967097995:::::) page of FARA.gov.
- [bulk_data_files/download_bulk_data_files.py](https://github.com/Howard-Center-Investigations/FARA_Archive/blob/main/bulk_data_files/download_bulk_data_files.py) downloads the csv files available for download from the [Bulk Data](https://efile.fara.gov/ords/fara/f?p=107:21::::::) page of FARA.gov.
- [.github/workflows/](https://github.com/Howard-Center-Investigations/FARA_Archive/tree/main/.github/workflows) contains the cron jobs used to automate these processes, running between 08:30 AM - 10:00 AM UTC daily.
